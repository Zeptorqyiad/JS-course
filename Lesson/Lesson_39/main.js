// Еще один список. В этот рак разбираем содержимое рюкзака и продолжаем учиться обрабатывать массивы.
// У каждого предмета есть кнопка "Вытащить из рюкзака", кликнув на которую должно произойти удаления элемента из списка.Она работает,
// 	но почему - то всегда удаляется только первый элемент списка.Попробуйте исправить эту проблему.
